...
function(netdata_bundle_libbpf)
    ...
    if(USE_LEGACY_LIBBPF)
        ...
        set(_libbpf_tag f5dcbae736e5d7f83a35718e01be1a8e3010fa39) # v1.7.0.0p_netdata
    endif()
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND ${MAKE_COMMAND} -C src CC=${CMAKE_C_COMPILER} BUILD_STATIC_ONLY=1 OBJDIR=build/ DESTDIR=../ LIBSUBDIR=${_libbpf_lib_dir} all
        BUILD_IN_SOURCE 1
        BUILD_BYPRODUCTS "${_libbpf_library}"
        INSTALL_COMMAND ${MAKE_COMMAND} -C src CC=${CMAKE_C_COMPILER} BUILD_STATIC_ONLY=1 OBJDIR=build/ DESTDIR=../ LIBSUBDIR=${_libbpf_lib_dir} install
        EXCLUDE_FROM_ALL 1
    )
